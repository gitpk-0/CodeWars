...
public class SortedSquaredArray {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(SortedSquaredArrayProgram1.sortedSquaredArray(new int[]{1, 2, 3, 5, 6, 8, 9})));
        System.out.println(Arrays.toString(SortedSquaredArrayProgram1.sortedSquaredArray(new int[]{-2, -1})));
        System.out.println(Arrays.toString(SortedSquaredArrayProgram1.sortedSquaredArray(new int[]{-5, -4, -3, -2, -1})));
        System.out.println(Arrays.toString(SortedSquaredArrayProgram1.sortedSquaredArray(new int[]{-10, -5, 0, 5, 10})));
...
class SortedSquaredArrayProgram1 {
    public static int[] sortedSquaredArray(int[] array) {
